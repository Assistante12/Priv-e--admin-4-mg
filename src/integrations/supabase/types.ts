  ...
  public: {
    Tables: {
      ...
      facebook_central_pages: {
        ...
        Relationships: [
          {
            foreignKeyName: "facebook_central_pages_assigned_workspace_id_fkey"
      ...
      workspace_unlocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "workspace_unlocks_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      has_workspace_access: { Args: { _scope: string }; Returns: boolean }
      is_workspace_member: { Args: { _scope: string }; Returns: boolean }
