...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DneGheIu.mjs");
...
var manifest = {
	...
	"52e8f902c3ab8fa862e987e3d3a360c9ae5dcdd4c2e2b2bba2ce1c12f955e7dc": {
		...
		importer: () => import("./admin-overview.functions-BZqiuMSW.mjs")
	},
	...
	"e9c551c5997021134409eb261e33aedfa05172b0edcea8974945a04fa951f6f7": {
		...
		importer: () => import("./ai-health.functions-DpnQGjiL.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bhc7uvGy.mjs").then((n) => n.t),
		import("./start-Cb5txxbY.mjs"),
