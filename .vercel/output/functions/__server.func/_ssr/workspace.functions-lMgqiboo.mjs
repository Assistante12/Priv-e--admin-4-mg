...
//#region node_modules/.nitro/vite/services/ssr/assets/workspace.functions-lMgqiboo.js
var UNLOCK_HOURS = 12;
...
var listWorkspaces = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({
	...
	const { isCentralAccount } = await import("./central-account.server-DZJV6O-Z.mjs");
