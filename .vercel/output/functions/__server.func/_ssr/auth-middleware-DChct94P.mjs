import { n as createMiddleware, o as getRequest } from "./server-BRvJ2kb2.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-DChct94P.js
		...
		for (const f of this.filters) {
			...
			switch (f.op) {
				...
				case "lt":
					if (itemVal >= f.value) return false;
					break;
				case "contains": if (Array.isArray(itemVal)) {
