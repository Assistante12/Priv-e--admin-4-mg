...
//#region node_modules/.nitro/vite/services/ssr/assets/workspace.functions-DlyBIoq9.js
var UNLOCK_HOURS = 12;
...
var listWorkspaces = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({
	...
	const { isCentralAccount } = await import("./central-account.server-BWDFnSW3.mjs");
